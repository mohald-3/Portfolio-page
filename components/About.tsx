...
const About: React.FC = () => {
  return (
    <section id="about" className="py-20 px-4 sm:px-6 lg:px-8 border-t border-zinc-200 dark:border-white/5">
              ...
              {profile.aboutBullets.map((bullet, idx) => (
                <div key={idx} className="flex gap-4 group">
                  <div className="flex-shrink-0 mt-1">
                    <CheckCircle2 className="w-6 h-6 text-purple-600/40 dark:text-purple-500/60 group-hover:text-purple-600 dark:group-hover:text-purple-500 transition-colors" />
                  </div>
